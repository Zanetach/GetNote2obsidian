...
class GetNoteSyncSettingTab extends PluginSettingTab {
  ...
  private async renderAsync(): Promise<void> {
    ...
    this.addSecretTextControl(clientIdSetting, {
      value: this.plugin.settings.clientId,
      placeholder: "Client ID",
      visible: this.showClientId,
    ...
    this.addSecretTextControl(apiKeySetting, {
      value: this.plugin.settings.apiKey,
      placeholder: "API Key",
      visible: this.showApiKey,
      onChange: async (value) => {
  ...
  private addSecretTextControl(
    ...
    setting
      .addText((text) => {
        ...
        text.inputEl.type = options.visible ? "text" : "password";
        text.inputEl.readOnly = options.readOnly ?? false;
      ...
      .addExtraButton((button) =>
        button
          .setIcon(options.visible ? "eye-off" : "eye")
          .setTooltip(options.visible ? "隐藏" : "显示")
